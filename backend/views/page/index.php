...
<div class="page-index">
    <div class="card card-outline card-secondary shadow-sm">
        <div class="card-header">
            <h3 class="card-title text-uppercase fw-bold"><i class="fas fa-file mr-2"></i> Manajemen Halaman</h3>
            <div class="card-tools">
                <?= Html::button('<i class="fas fa-plus"></i> Buat Halaman', [
                    'value' => Url::to(['create']),
                    'class' => 'btn btn-secondary btn-sm showModalButton',
                    'title' => 'Buat Halaman Statis Baru'
                ]) ?>
            </div>
        </div>
...
Modal::begin([
    'id' => 'modal',
    'size' => 'modal-xl',
    'title' => '<h4 class="modal-title">Halaman</h4>',
]);
